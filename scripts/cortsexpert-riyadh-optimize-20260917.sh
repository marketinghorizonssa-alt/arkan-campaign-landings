...
for slug,(title,terms) in clusters.items():
...
'محامي عام':'/riyadh-lawyer/','مكتب محاماة ومستشار':'/riyadh-lawyer/','تواصل مباشر / الأفضل':'/riyadh-lawyer/','استشارة محامي / مستشار':'/legal-consultation/','استشارات عامة / أونلاين':'/legal-consultation/'},
'Search | Riyadh | Core Cases':{
'قضايا عمالية ومكتب العمل':'/labor-law/','تحصيل ديون وتنفيذ ومطالبات':'/debt-collection-execution/','أحوال شخصية / طلاق / نفقة / حضانة':'/family-inheritance/','مواريث وتركات':'/inheritance-estates/','تجاري وعقود وتحكيم':'/business-commercial-law/'},
'Search | Riyadh | Specialized':{
'علامات تجارية وملكية فكرية':'/trademark-intellectual-property/','شركات / تأسيس / تصفية / إفلاس':'/company-law/','عقارات وتوثيق وصكوك':'/real-estate-law/','جنائي وخدمات قانونية متخصصة':'/criminal-specialized/'}}
}
(root/'_campaign-routing.json').write_text(json.dumps(routing,ensure_ascii=False,indent=2),encoding='utf-8')
PY
# Remove temporary inventory created during audit.
rm -f "$ROOT/__inventory.txt"
# Keep a server-side deployment marker for verification.
printf '%s\n' 'CORTS_RIYADH_LP_V3_20260917' > "$ROOT/.ads-lp-version"
