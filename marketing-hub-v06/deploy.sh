...
for F in index.php api.php webhook.php connect.php init_setup.php; do
  curl -Lfs "$B/$F" -o "$D/$F"
done
for F in api.php webhook.php connect.php init_setup.php; do
  php -l "$D/$F" >/dev/null
done
chmod 600 "$D/init_setup.php" || true
