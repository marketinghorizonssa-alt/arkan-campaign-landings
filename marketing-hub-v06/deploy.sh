...
for F in api.php lead_report_api.php webhook.php wa_click_attribution.php sync_pcare_wa_attribution.php google_conversion_feed.php connect.php init_setup.php flush_outbox.php local_quality_v2.php lead_pool_worker.php lead_pool_dispatcher.php lead_pool_patch_v2.php lead_pool_cutover.php ensure_ycloud_stage_events.php; do
  php -l "$D/$F" >/dev/null
done
