...
for F in index.php api.php webhook.php wa_click_attribution.php sync_pcare_wa_attribution.php google_conversion_feed.php google_sheet_backfill.php google_sheet_stage_export.php qualified_lead_pool_feed.php diagnose_bcare_attribution.php repair_recent_attribution.php reset_pcare_test_contact.php connect.php init_setup.php flush_outbox.php local_quality_v2.php lead_pool_worker.php lead_pool_dispatcher.php lead_pool_patch_v2.php lead_pool_cutover.php ensure_ycloud_stage_events.php quality_rules_v2.json platform_stage_config.json lead_pool_config.json wa_attribution_clients.json horizons-wa-attribution.js; do
  curl -Lfs "$B/$F" -o "$D/$F"
done
...
printf 'marketing-v15-horizons-signed-wa-token-deployed\n'
